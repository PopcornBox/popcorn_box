...
public class BoardReply {
	...
	public String toString() {
		return "BoardReply [board_reply_no=" + board_reply_no + ", board_reply_content=" + board_reply_content
				+ ", user_nickname=" + user_nickname + ", board_reply_update_time=" + board_reply_update_time
				+ ", board_no=" + board_no + "]";
	}
